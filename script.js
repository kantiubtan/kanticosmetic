...
function bindEvents() {
  ...
  $$("[data-account-open]").forEach((button) => button.addEventListener("click", () => openAccountPortal(button.dataset.accountOpen)));
...
function openAccountPortal(preferredMode = "login") {
  const mode = state.user ? "account" : preferredMode;
